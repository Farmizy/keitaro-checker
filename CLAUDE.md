...
Система автоматического управления бюджетами рекламных кампаний Facebook. Тянет лиды из Keitaro Tracker, расходы из fbtool.pro, и по "лестнице" правил повышает бюджеты успешным кампаниям или останавливает убыточные. Проверка каждые 10 минут.
